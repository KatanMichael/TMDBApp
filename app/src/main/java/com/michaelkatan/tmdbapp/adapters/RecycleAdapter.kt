...
class RecycleAdapter(val items: Array<Result>,val context: Context) : RecyclerView.Adapter<RecycleAdapter.ResultViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ResultViewHolder, position: Int)
    {
        ...
        holder.movieDescription.setText(items.get(position).overview)

        holder.movieReleaseData.setText(items.get(position).release_date)
    }
    ...
    class ResultViewHolder(val view: View) : RecyclerView.ViewHolder(view)
    {
        ...
        val movieDescription : TextView = view.findViewById(R.id.result_movie_description)
        val movieReleaseData : TextView = view.findViewById(R.id.result_movie_realeseDate)
    }
}